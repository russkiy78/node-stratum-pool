...
var stratum_zcash = require('./stratum_zcash.js');
var util_zcash = require('./util_zcash.js');
...
var pool = module.exports = function pool(options, authorizeFn, logger) {
    ...
    this.start = function () {
        ...
        if (this.options.coin['stratum'] !== undefined) {
            if (this.options.coin['stratum'] === 'zcash') {
                console.log('ZCASH!!!!!');
                stratum = stratum_zcash;
                util = util_zcash;
            }
        }
