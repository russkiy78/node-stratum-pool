...
var StratumClient = function(options, logger){
        ...
        if (options.coin.algorithm === 'equihash') {
            switch(message.method){
                case 'mining.subscribe':
                    ...
                    handleSubscribeEquihash(message);
                    break;
                case 'mining.authorize':
                    logger.silly('mining.authorize message from  miner');
                    handleAuthorizeEquihash(message);
                    break;
    ...
    function handleSubscribeEquihash(message){
        if (!_this.authorized) {
    ...
    function handleAuthorizeEquihash(message) {
    ...
    this.sendDifficulty  =
        options.coin.algorithm === 'equihash' ? function(difficulty){
